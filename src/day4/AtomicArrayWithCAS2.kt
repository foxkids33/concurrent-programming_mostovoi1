...
class AtomicArrayWithCAS2<E : Any>(size: Int, initialValue: E) {
    ...
    fun cas2(
        ...
        while (true) {
            ...
            val minimalIndex = minOf(index1, index2)
            val minimalIndexValue = if (index1 < index2) expected1 else expected2
            if (array[minimalIndex].compareAndSet(minimalIndexValue, descriptor)) {
