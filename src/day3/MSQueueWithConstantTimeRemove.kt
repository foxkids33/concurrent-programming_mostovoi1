...
class MSQueueWithConstantTimeRemove<E> : QueueWithRemove<E> {
    ...
    private class Node<E>(
        ...
        fun removePhysically() {
            // Check whether 'this' is not the head or tail, and 'this.next' is not null
            ...
            // Update the 'next' link of prevNode atomically
            prevNode.next.getAndSet(nextNode)

            // Update the 'prev' link of nextNode atomically if it is not null
            if (nextNode != null) {
                while (true) {
            ...
            // If the previous or next nodes are extracted or removed, recursively call removePhysically
